...
const ModalNewProject = ({ isOpen, onClose }: Props) => {
  ...
  const handleSubmit = async () => {
    // if projectName or startDate or endDate doesn't exist, return
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Create New Project">
      ...
      >
        ...
        />
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-2"></div>
        <input
          type="date"
          className={inputStyles}
          value={startDate}
        ...
        <button
          ...
          //   disabled when it is when not valid or loading
